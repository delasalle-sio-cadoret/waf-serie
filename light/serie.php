    ...
    <div class="main-header row">
      <div class="col-sm-6 col-xs-7">
        ...
        <ul class="user-info pull-left">          
          <li class="profile-info dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"> <img width="44" class="img-circle avatar" alt="" src="https://scontent-cdg2-1.xx.fbcdn.net/v/t1.0-1/p480x480/25591878_10213085965735404_8771027600799271983_n.jpg?oh=81696e148c828f6f5b596c3f98738e52&oe=5AF8755C">Youn Cadoret<span class="caret"></span></a>
	...
	<!-- /main header -->
		...
		<div class="col-lg-12">
			<div class="page-heading clearfix">
				<h1 class="page-title pull-left">Mes Series</h1>
			</div>
		</div>
	</div>
	<!-- /secondary header -->
 ...
 <div class="main-container">
   ...
   <div class="main-content">
			   ...
			   <div class="cards-container box-view grid-view">
				   <div class="row">
					...
					<?php	
							include('DAO.php');
							$stat = new DAO();
							echo $stat->listeOeuvre();
					?>

					<a href="serie-action.php">
					   <div class="col-lg-3 col-sm-6 animatedParent animateOnce z-index-49">
						   <!-- Card -->
						   <div class="animated fadeInUp">
							   <!-- Card header -->
							   <div class="card-header">
							   		<center><img style="width: 165px; height: 237px;" src="https://media.senscritique.com/media/000017274085/160/American_Vandal.jpg"></center>
							   </div>
							   <!-- /card header -->
							   <!-- Card content -->
							   <div class="card-content">
								   <center><h3 style="font-weight:bold;">American Vandal</h3></center>
							   </div>
							   <!-- /card content -->							   
						   </div>
						   <!-- /card --> 
					...
					<a href="serie-action.php">
					   <div class="col-lg-3 col-sm-6 animatedParent animateOnce z-index-48">
						   ...
						   <div class="animated fadeInUp">
							   <!-- Card header -->
							   <div class="card-header">
							   		<center><img style="width: 165px; height: 237px;" src="https://media.senscritique.com/media/000004080454/160/Game_of_Thrones.jpg"></center>
							   </div>
							   <!-- /card header -->
							   <!-- Card content -->
							   <div class="card-content">
								   <center><h3 style="font-weight:bold;">Game of Thrones</h3></center>
							   </div>
							   <!-- /card content -->							   
						   </div>
						   <!-- /card --> 
					...
					<a href="serie-action.php">
					   <div class="col-lg-3 col-sm-6 animatedParent animateOnce z-index-47">
						   ...
						   <div class="animated fadeInUp">
							   <!-- Card header -->
							   <div class="card-header">
							   		<center><img style="width: 165px; height: 237px;" src="https://media.senscritique.com/media/000017408746/160/Dark.jpg"></center>
							   </div>
							   <!-- /card header -->
							   <!-- Card content -->
							   <div class="card-content">
								   <center><h3 style="font-weight:bold;">Dark</h3></center>
							   </div>
							   <!-- /card content -->							   
						   </div>
						   <!-- /card --> 
					...
					<a href="serie-action.php">
					   <div class="col-lg-3 col-sm-6 animatedParent animateOnce z-index-46">
						   ...
						   <div class="animated fadeInUp">
							   <!-- Card header -->
							   <div class="card-header">
							   		<center><img style="width: 165px; height: 237px;" src="https://media.senscritique.com/media/000009402307/160/Dexter.jpg"></center>
							   </div>
							   <!-- /card header -->
							   <!-- Card content -->
							   <div class="card-content">
								   <center><h3 style="font-weight:bold;">Dexter</h3></center>
							   </div>
							   <!-- /card content -->							   
						   </div>
						   <!-- /card --> 
					...
					<a href="serie-action.php">
					   <div class="col-lg-3 col-sm-6 animatedParent animateOnce z-index-46">
						   ...
						   <div class="animated fadeInUp">
							   <!-- Card header -->
							   <div class="card-header">
							   		<center><img style="width: 165px; height: 237px;" src="https://media.senscritique.com/media/000006470599/160/The_Walking_Dead.jpg"></center>
							   </div>
							   <!-- /card header -->
							   <!-- Card content -->
							   <div class="card-content">
								   <center><h3 style="font-weight:bold;">The Walking Dead</h3></center>
							   </div>
							   <!-- /card content -->							   
						   </div>
						   <!-- /card --> 
					...
					<a href="serie-action.php">
					   <div class="col-lg-3 col-sm-6 animatedParent animateOnce z-index-46">
						   ...
						   <div class="animated fadeInUp">
							   <!-- Card header -->
							   <div class="card-header">
							   		<center><img style="width: 165px; height: 237px;" src="https://media.senscritique.com/media/000011943492/160/Flash.jpg"></center>
							   </div>
							   <!-- /card header -->
							   <!-- Card content -->
							   <div class="card-content">
								   <center><h3 style="font-weight:bold;">Flash</h3></center>
							   </div>
							   <!-- /card content -->							   
						   </div>
						   <!-- /card --> 
					...
					<a href="serie-action.php">
					   <div class="col-lg-3 col-sm-6 animatedParent animateOnce z-index-46">
						   ...
						   <div class="animated fadeInUp">
							   <!-- Card header -->
							   <div class="card-header">
							   		<center><img style="width: 165px; height: 237px;" src="https://media.senscritique.com/media/000006469472/160/Breaking_Bad.jpg"></center>
							   </div>
							   <!-- /card header -->
							   <!-- Card content -->
							   <div class="card-content">
								   <center><h3 style="font-weight:bold;">Breaking Bad</h3></center>
							   </div>
							   <!-- /card content -->							   
						   </div>
						   <!-- /card --> 
	   ...
	   <footer class="animatedParent animateOnce z-index-10"> 
		   <div class="footer-main animated fadeInUp slow">&copy; 2018 <strong>Cadoret</strong> Youn</div>
	   </footer>	
	   <!-- /footer -->
